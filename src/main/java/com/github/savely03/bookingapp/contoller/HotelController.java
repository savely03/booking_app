...
public class HotelController {
    ...
    public String update(@PathVariable Long id, Hotel hotel) {
    ...
    @GetMapping("/free")
    public String findAllFreeByFilter(Model model, HotelFilterDto filter) {
    ...
    @GetMapping("/index")
    public String hotelsIndex(Model model) {
